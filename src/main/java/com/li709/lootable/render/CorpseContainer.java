package com.li709.lootable.render;
...
public class CorpseContainer extends net.minecraft.inventory.Container {
    ...
    public CorpseContainer(InventoryPlayer playerItems, IInventory entity) {
        ...
        while (index < 4) {
            // armor
            final int i = index;
            this.addSlotToContainer(new Slot(targetInventory, i, 8, 8 + 18 * i) {
                @Override
        ...
        while (index < EQUIPMENT_SLOTS.length) {
            // held items
            final int i = index;
            this.addSlotToContainer(new Slot(targetInventory, i, 8 + 18 * (i - 4), 98) {
                @SideOnly(Side.CLIENT)
                public String getSlotTexture() {
